...
<?php
	...
	if(isset($_GET['publicationid'])) $publicationid=$_GET['publicationid'];
	$organid = $con->GetDescr("select OrganID from tbl_publicationnews where PublicationNewsID = '$publicationid'");
...
<div class="row-fluid">
	<div class="hdtitle">&nbsp;&nbsp;Хэвлэлийн тойм
  ...
  <div class="span3">
	  <?php $page="publication"; require_once 'newsorganclass.php';?>
			<?php require_once 'poll.php';?>
  </div>
  <div class="span8">
	  <?php require_once 'publicationdetailcontent.php';?>
  </div>
</div>
