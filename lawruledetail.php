...
<?php
	...
	if($_GET['lawruleid']) $lawruleid=$_GET['lawruleid'];
	$organclassid=$con->GetDescr("select OrganClassID from tbl_lawrule T left join ref_organ O on T.OrganID=O.OrganID where T.IsShow='YES' and LawRuleID='$lawruleid'");
	$organid = $con->GetDescr("select OrganID from tbl_lawrule where LawRuleID = '$lawruleid'");
	$pagelink1=$rf."/lawrule";
?>
...
<div class="row-fluid">
  ...
  <div class="span3">
	  <?php $page="lawrule"; require_once 'newsorganclass.php';?>
			<?php require_once 'poll.php';?>
  </div>
  <div class="span8">
	  <?php require_once 'lawruledetailcontent.php';?>
  </div>
</div>
