...
<?php
	...
	if(isset($_GET['speechid'])) $speechid=$_GET['speechid'];
	
	$organid = $con->GetDescr("select OrganID from tbl_speech where SpeechID = '$speechid'");
...
<div class="row-fluid">
	<div class="hdtitle">&nbsp;&nbsp;Илтгэл, хэлсэн үг
  ...
  <div class="span3">
	  <?php $page="speech"; require_once 'newsorganclass.php';?>
			<?php require_once 'poll.php';?>
  </div>
  <div class="span8">
	  <?php require_once 'speechdetailcontent.php';?>
  </div>
</div>
