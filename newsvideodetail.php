...
<?php
	...
	if($_GET['videonewsid']) $videonewsid=$_GET['videonewsid'];
	$organclassid=$con->GetDescr("select OrganClassID from tbl_videonews T left join ref_organ O on T.OrganID=O.OrganID where T.IsShow='YES' and VideoNewsID='$videonewsid'");
	$organid = $con->GetDescr("select OrganID from tbl_videonews where VideoNewsID = '$videonewsid'");
	$pagelink1=$rf."/news/video";
?>
...
<div class="row-fluid">
	<div class="hdtitle">&nbsp;&nbsp;Дүрстэй мэдээ
  ...
  <div class="span8">
	  <?php require_once 'newsvideodetailcontent.php';?>
  </div>
</div>
