...
<?php
	...
	if($_GET['reportid']) $reportid=$_GET['reportid'];
	
	$organid = $con->GetDescr("select OrganID from tbl_report where ReportID = '$reportid'");
...
<div class="row-fluid">
	<div class="hdtitle">&nbsp;&nbsp;Төсөв, НЭЗ-ийн зорилт
  ...
  <div class="span8">
	  <?php require_once 'reportdetailcontent.php';?>
  </div>
</div>
