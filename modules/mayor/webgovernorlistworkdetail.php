...
<?php
	...
	$govformtitle=$con->GetDescr("select GovernorName".$_SESSION['mayor_lang']." from mayor_governor where GovernorLink='listwork'");
...
<BODY>
	...
	<div class="container">
		<table cellpadding="0" cellspacing="0" width="100%">
			...
			<td width="600" valign="top"><?php require_once 'formgovernorlistworkdetail.php';?></td>
