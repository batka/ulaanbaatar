	...
	<?php
		...
		<table class="tableinfo">
			<tr>
				...
				<th width="">Нийслэлийн шуурхай</th>
				<th width="">Биелэлт</th>	
			</tr>
			<?php			
			...
			<tr>
				...
				<td align="center"><b><?=$row[$i]['date']?></b></td>
				<td align="center"><a href="javascript:none();" onClick="OpenWindow('<?=$rf?>/report/printreport.php?fn=councilprompt.php&qs1=promptid=<?=$row[$i]['CouncilPromptnessID'];?>&qs2=descr=Descr',600, 600); return false;" class="llink" ><?=$row[$i]['Title']?></a></td>
				<td align="center">
				<?php if(!empty($row[$i]['Descr1'])){?>
					<a href="javascript:none();" onClick="OpenWindow('<?=$rf?>/report/printreport.php?fn=councilprompt.php&qs1=promptid=<?=$row[$i]['CouncilPromptnessID'];?>&qs2=descr=Descr1',600, 600); return false;" class="llink" ><img src="<?=$rf;?>/images/web/morefile.png" style="vertical-align: middle;"> биелэлт</a>
				<?php }?>
				</td>
			</tr>
			<tr>
				<td colspan="4" style="border-top: 1px solid #cccccc; height: 0px;"></td>
			</tr>
			<?php }?>
		</table>	
	</div>	
