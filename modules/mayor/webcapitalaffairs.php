				...
				<div class="formcenter">
					...
					<?php
						...
						for($i=0; $i<$rowcount; $i++){
							$link="$rf/capital/affairs/detail/".$row[$i]['CapitalAffairsID']."/";
					?>
						<div class="dcontent">
							...
							<div class="descr">
							<?php if(!empty($row[$i]['ImageSource']) && file_exists("$drf/images/capital/capaffairs/".$row[$i]['ImageSource'])){?>
								<a href="<?=$link?>"><img class="dcontentimg" src="<?=$rf?>/images/capital/capaffairs/small/<?=$row[$i]['ImageSource']?>" height="120"/></a>
							<?php }
