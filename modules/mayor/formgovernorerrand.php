<?php
	$lmenutitle=$con->GetDescr("select GovernorName".$_SESSION['mayor_lang']." from mayor_governor where GovernorLink='errand'");
			...
			<?php
				...
				<table class="tableinfo" cellpadding="0" cellspacing="1">
					...
					<tr>
						...
						<td align="left"><a href="javascript:none();" class="llink" onClick="OpenWindow('<?=$rf?>/report/printreport.php?fn=councilerrand.php&qs1=errandid=<?=$row[$i]['ErrandID'];?>&qs2=descr=Descr',600, 600); return false;"><?=$row[$i]['Title']?></a></td>
						<td align="center"><a href="javascript:none();" onClick="OpenWindow('<?=$rf?>/report/printreport.php?fn=councilerrand.php&qs1=errandid=<?=$row[$i]['ErrandID'];?>&qs2=descr=Descr1',600, 600); return false;"><img src="<?=$rf?>/images/web/morefile.png" style="vertical-align: middle;"> биелэлт</a></td>
						<td align="center">
					...
					<tr>
						<td colspan="5" style="border-top: 1px solid #cccccc; height: 0px;"></td>
					</tr>
					<?php }?>
				</table>	
			</div>	
